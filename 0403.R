...
barplot(a_, xlim = c(0, length(a_)+1),xlab="빈도", ylab = "Frequency",main="한 자리 숫자 (0~9)")
axis(side = 1, at = seq(52, length(a_)-159, length.out=4),line=0.2,labels = format(seq(99600, 100200, by = 200),scientific = FALSE))
barplot(a_, xlim = c(0, length(a_)+1),xlab="빈도/기대빈도", ylab = "Frequency",main="한 자리 숫자 (0~9)")
axis(side = 1, at = seq(52, length(a_)-159, length.out=4),line=0.2, labels = format(seq(99600, 100200, by = 200),scientific = FALSE))
...
barplot(a_, xlim = c(0, length(a_)+1),xlab="빈도", ylab = "Frequency",main="두 자리 숫자 (00~99)")
axis(side = 1, at = seq(3, length(a_)-7, length.out=8),line=0.2, labels = format(seq(4850, 5200, by = 50),scientific = FALSE))
barplot(a_, xlim = c(0, length(a_)+1),xlab="빈도/기대빈도", ylab = "Frequency",main="두 자리 숫자 (00~99)")
axis(side = 1, at = seq(3, length(a_)-7, length.out=8),line=0.2,labels = format(seq(4850, 5200, by = 50),scientific = FALSE))
...
barplot(a_, xlim = c(0, length(a_)+1),xlab="빈도", ylab = "Frequency",main="세 자리 숫자 (000~999)")
axis(side = 1, at = seq(14, length(a_)-13, length.out=6),line=0.2,labels = format(seq(280, 380, by = 20),scientific = FALSE))
barplot(a_, xlim = c(0, length(a_)+1),xlab="빈도/기대빈도", ylab = "Frequency",main="세 자리 숫자 (000~999)")
axis(side = 1, at = seq(14, length(a_)-13, length.out=6),line=0.2, labels = format(seq(280, 380, by = 20),scientific = FALSE))